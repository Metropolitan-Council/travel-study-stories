#' input_category_row UI Function
#'
...
mod_input_category_row_ui <- function(id) {
  ns <- NS(id)
  tagList(
    selectInput(
      inputId = ns("category"),
...
#' input_category_row Server Functions
#'
#' @noRd
mod_input_category_row_server <- function(id) {
...
# mod_input_category_row_server("input_category_row_1")
